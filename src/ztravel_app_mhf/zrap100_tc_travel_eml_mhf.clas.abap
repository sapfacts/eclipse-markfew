"! @testing BDEF:ZI_TRAVEL_M_MHF
CLASS zrap100_tc_travel_eml_mhf DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC
FOR TESTING
...
CLASS zrap100_tc_travel_eml_mhf IMPLEMENTATION.
  ...
  METHOD create_with_action.
    ...
    MODIFY ENTITIES OF zi_travel_m_mhf
     ENTITY Travel
    ...
    SELECT * FROM zi_travel_m_mhf INTO TABLE @DATA(lt_travel). "#EC CI_NOWHERE
