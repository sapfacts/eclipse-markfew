CLASS zrap620_cl_ce_products_mhf DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
  ...
  PUBLIC SECTION.
    ...
    TYPES t_product_range TYPE RANGE OF zrap620_sc_products_mhf=>tys_sepmra_i_product_etype.
    TYPES t_business_data TYPE zrap620_sc_products_mhf=>tyt_sepmra_i_product_etype.
    TYPES t_business_data_external TYPE TABLE OF zrap620_ce_products_mhf.
     ...
     odata_client_proxy = /iwbep/cl_cp_factory_remote=>create_v2_remote_proxy(
       EXPORTING
          is_proxy_model_key       = VALUE #( repository_id       = 'DEFAULT'
                                              proxy_model_id      = 'ZRAP620_SC_PRODUCTS_MHF'
