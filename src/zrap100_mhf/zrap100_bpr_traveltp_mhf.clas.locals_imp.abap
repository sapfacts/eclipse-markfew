...
CLASS lhc_zrap100_r_traveltp_mhf IMPLEMENTATION.
  ...
  METHOD earlynumbering_create.
    ...
    DATA:
      entity           TYPE STRUCTURE FOR CREATE ZRAP100_R_TravelTP_MHF,
    ...
    ELSE.
      ...
      SELECT SINGLE FROM zrap100_atravMHF FIELDS MAX( travel_id ) AS travelID INTO @travel_id_max.
      "Get max travel ID from draft table
      SELECT SINGLE FROM zrap100_dtravMHF FIELDS MAX( travelid ) INTO @DATA(max_travelid_draft).
